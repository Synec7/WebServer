 ...
 */
class HttpRequestHandler : IRequestHandler {
...
class HttpRequest(val method: HttpMethod, val headers: List<HttpHeader>, var body: ByteArray? = null): IRequest